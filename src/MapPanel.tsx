...
export class MapPanel extends Component<MapPanelProps> {
  ...
  calculateOptionsChanges = (currOptions) => {
    ...
    for(let i=0; i<LAYER_LIMIT; i++){
      ...
      optionsToWatch.push(`layers[${i}].autodetect.dstNameColumn`);
      optionsToWatch.push(`layers[${i}].autodetect.dstLatitudeColumn`);
      optionsToWatch.push(`layers[${i}].autodetect.dstLongitudeColumn`);
      optionsToWatch.push(`layers[${i}].autodetect.srcNameColumn`);
      optionsToWatch.push(`layers[${i}].autodetect.srcLatitudeColumn`);
      optionsToWatch.push(`layers[${i}].autodetect.srcLongitudeColumn`);
    }
