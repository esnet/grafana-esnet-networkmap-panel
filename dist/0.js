...
(function () {
  ...
  (function (c, x) {
    "object" === ( false ? undefined : _typeof(exports)) && "undefined" !== typeof module ? x(exports) :  true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports], __WEBPACK_AMD_DEFINE_FACTORY__ = (x),
    ...
    function ca(a, b, e) {
      var l,
          ...
          c = null,
          da = null;
      if (null != b) for (l in void 0 !== b.ref && (da = b.ref), void 0 !== b.key && (c = "" + b.key), b) {
        ea.call(b, l) && !fa.hasOwnProperty(l) && (f[l] = b[l]);
      }
      var k = arguments.length - 2;
      if (1 === k) f.children = e;else if (1 < k) {
      ...
      if (a && a.defaultProps) for (l in k = a.defaultProps, k) {
        void 0 === f[l] && (f[l] = k[l]);
      }
      return {
        $$typeof: w,
    ...
    function M(a) {
      return "object" === _typeof(a) && null !== a && a.$$typeof === w;
    }
    ...
    function C(a, b, e, l, f) {
      ...
      if (d) return d = a, f = f(d), a = "" === l ? "." + N(d, 0) : l, Array.isArray(f) ? (e = "", null != a && (e = a.replace(ia, "$&/") + "/"), C(f, b, e, "", function (a) {
        return a;
      })) : null != f && (M(f) && (f = va(f, e + (!f.key || d && d.key === f.key ? "" : ("" + f.key).replace(ia, "$&/") + "/") + a)), b.push(f)), 1;
      d = 0;
      l = "" === l ? "." : l + ":";
      if (Array.isArray(a)) for (var k = 0; k < a.length; k++) {
        ...
        var h = l + N(c, k);
        d += C(c, b, e, h, f);
      } else if (h = x(a), "function" === typeof h) for (a = h.call(a), k = 0; !(c = a.next()).done;) {
    ...
    function Q(a) {
      z = !1;
      P(a);
      if (!u) if (null !== p(q)) u = !0, _A(R);else {
        var b = p(r);
    ...
    v.prototype.setState = function (a, b) {
      if ("object" !== _typeof(a) && "function" !== typeof a && null != a) throw Error(y(85));
    ...
    if ("undefined" === typeof window || "function" !== typeof MessageChannel) {
      ...
      var _A = function A(a) {
        null !== B ? setTimeout(_A, 0, a) : (B = a, setTimeout(ra, 0));
      };
    ...
    d = {
      ...
      Scheduler: {
        ...
        unstable_scheduleCallback: function unstable_scheduleCallback(a, b, c) {
          ...
          c > d ? (a.sortIndex = c, O(r, a), null === p(q) && a === p(r) && (z ? S() : z = !0, G(Q, c - d))) : (a.sortIndex = e, O(q, a), u || H || (u = !0, _A(R)));
          return a;
        },
